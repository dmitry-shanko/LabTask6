...
public class XSLTransformer 
{
	...
	private String jdomAddProductTemplate;
	private String jdomValidationTemplate;
	...
	/**
	 * @return the jdomAddProductTemplate
	 */
	public String getJdomAddProductTemplate() {
		return jdomAddProductTemplate;
	}

	/**
	 * @param jdomAddProductTemplate the jdomAddProductTemplate to set
	 */
	public void setJdomAddProductTemplate(String jdomAddProductTemplate) {
		this.jdomAddProductTemplate = jdomAddProductTemplate;
	}

	/**
	 * @return the jdomValidationTemplate
	 */
	public String getJdomValidationTemplate() {
		return jdomValidationTemplate;
	}

	/**
	 * @param jdomValidationTemplate the jdomValidationTemplate to set
	 */
	public void setJdomValidationTemplate(String jdomValidationTemplate) {
		this.jdomValidationTemplate = jdomValidationTemplate;
	}
	...
	{		
		...
		case XSLConstants.VALIDATION_TEMPLATE:
			fileName = productTemplate;
			break;
		case XSLConstants.JDOM_ADD_PRODUCT_TEMPLATE:
			fileName = jdomAddProductTemplate;
			break;
		case XSLConstants.JDOM_VALIDATION_TEMPLATE:
			fileName = jdomValidationTemplate;
			break;
		}
	...
	public String transformAndWrite(int template, Map<String, String> params) throws TransformerException
	{
		long lastModified;
		String fileName = null;
		switch (template)
